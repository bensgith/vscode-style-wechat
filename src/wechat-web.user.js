...
(function() {
    ...
    const emoji_names_map = new Map(
            [
                ...
                ['emoji1f44c', 'OK'], ['emoji1f3af', 'Target'], ['emoji1f412', 'Monkey_2']
            ]
        );
    ...
    const unicode_emoji_map = new Map(
        [
            ...
            */
            ...
            ['🧑', 'person'],['👱', 'person:_blond_hair'],['👨', 'man'],['🧔', 'person:_beard'],['👩', 'woman'],
            ...
            // Food & Drink
            ['🍇', 'grapes'],['🍈', 'melon'],
            ['🍉', 'watermelon'],['🍊', 'tangerine'],['🍋', 'lemon'],['🍌', 'banana'],['🍍', 'pineapple'],
            ['🥭', 'mango'],['🍎', 'red_apple'],['🍏', 'green_apple'],['🍐', 'pear'],['🍑', 'peach'],
            ['🍒', 'cherries'],['🍓', 'strawberry'],['🫐', 'blueberries'],['🥝', 'kiwi_fruit'],['🍅', 'tomato'],
            ['🫒', 'olive'],['🥥', 'coconut'],['🥑', 'avocado'],['🍆', 'eggplant'],['🥔', 'potato'],
            ['🥕', 'carrot'],['🌽', 'ear_of_corn'],['🌶', 'hot_pepper'],['🫑', 'bell_pepper'],['🥒', 'cucumber'],
            ['🥬', 'leafy_green'],['🥦', 'broccoli'],['🧄', 'garlic'],['🧅', 'onion'],['🥜', 'peanuts'],
            ['🫘', 'beans'],['🌰', 'chestnut'],['🫚', 'ginger_root'],['🫛', 'pea_pod'],['🍞', 'bread'],
            ['🥐', 'croissant'],['🥖', 'baguette_bread'],['🫓', 'flatbread'],['🥨', 'pretzel'],['🥯', 'bagel'],
            ['🥞', 'pancakes'],['🧇', 'waffle'],['🧀', 'cheese_wedge'],['🍖', 'meat_on_bone'],['🍗', 'poultry_leg'],
            ['🥩', 'cut_of_meat'],['🥓', 'bacon'],['🍔', 'hamburger'],['🍟', 'french_fries'],['🍕', 'pizza'],
            ['🌭', 'hot_dog'],['🥪', 'sandwich'],['🌮', 'taco'],['🌯', 'burrito'],['🫔', 'tamale'],
            ['🥙', 'stuffed_flatbread'],['🧆', 'falafel'],['🥚', 'egg'],['🍳', 'cooking'],['🥘', 'shallow_pan_of_food'],
            ['🍲', 'pot_of_food'],['🫕', 'fondue'],['🥣', 'bowl_with_spoon'],['🥗', 'green_salad'],['🍿', 'popcorn'],
            ['🧈', 'butter'],['🧂', 'salt'],['🥫', 'canned_food'],['🍱', 'bento_box'],['🍘', 'rice_cracker'],
            ['🍙', 'rice_ball'],['🍚', 'cooked_rice'],['🍛', 'curry_rice'],['🍜', 'steaming_bowl'],['🍝', 'spaghetti'],
            ['🍠', 'roasted_sweet_potato'],['🍢', 'oden'],['🍣', 'sushi'],['🍤', 'fried_shrimp'],['🍥', 'fish_cake_with_swirl'],
            ['🥮', 'moon_cake'],['🍡', 'dango'],['🥟', 'dumpling'],['🥠', 'fortune_cookie'],['🥡', 'takeout_box'],
            ['🦀', 'crab'],['🦞', 'lobster'],['🦐', 'shrimp'],['🦑', 'squid'],['🦪', 'oyster'],
            ['🍦', 'soft_ice_cream'],['🍧', 'shaved_ice'],['🍨', 'ice_cream'],['🍩', 'doughnut'],['🍪', 'cookie'],
            ['🎂', 'birthday_cake'],['🍰', 'shortcake'],['🧁', 'cupcake'],['🥧', 'pie'],['🍫', 'chocolate_bar'],
            ['🍬', 'candy'],['🍭', 'lollipop'],['🍮', 'custard'],['🍯', 'honey_pot'],['🍼', 'baby_bottle'],
            ['🥛', 'glass_of_milk'],['☕', 'hot_beverage'],['🫖', 'teapot'],['🍵', 'teacup_without_handle'],['🍶', 'sake'],
            ['🍾', 'bottle_with_popping_cork'],['🍷', 'wine_glass'],['🍸', 'cocktail_glass'],['🍹', 'tropical_drink'],['🍺', 'beer_mug'],
            ['🍻', 'clinking_beer_mugs'],['🥂', 'clinking_glasses'],['🥃', 'tumbler_glass'],['🫗', 'pouring_liquid'],['🥤', 'cup_with_straw'],
            ['🧋', 'bubble_tea'],['🧃', 'beverage_box'],['🧉', 'mate'],['🧊', 'ice'],['🥢', 'chopsticks'],
            ['🍽', 'fork_and_knife_with_plate'],['🍴', 'fork_and_knife'],['🥄', 'spoon'],['🔪', 'kitchen_knife'],['🫙', 'jar'],
            ['🏺', 'amphora'],
            // Travel & Places
            ['🌍', 'globe_showing_Europe-Africa'],['🌎', 'globe_showing_Americas'],['🌏', 'globe_showing_Asia-Australia'],['🌐', 'globe_with_meridians'],
            ['🗺', 'world_map'],['🗾', 'map_of_Japan'],['🧭', 'compass'],['🏔', 'snow-capped_mountain'],['⛰', 'mountain'],
            ['🌋', 'volcano'],['🗻', 'mount_fuji'],['🏕', 'camping'],['🏖', 'beach_with_umbrella'],['🏜', 'desert'],
            ['🏝', 'desert_island'],['🏞', 'national_park'],['🏟', 'stadium'],['🏛', 'classical_building'],['🏗', 'building_construction'],
            ['🧱', 'brick'],['🪨', 'rock'],['🪵', 'wood'],['🛖', 'hut'],['🏘', 'houses'],
            ['🏚', 'derelict_house'],['🏠', 'house'],['🏡', 'house_with_garden'],['🏢', 'office_building'],['🏣', 'Japanese_post_office'],
            ['🏤', 'post_office'],['🏥', 'hospital'],['🏦', 'bank'],['🏨', 'hotel'],['🏩', 'love_hotel'],
            ['🏪', 'convenience_store'],['🏫', 'school'],['🏬', 'department_store'],['🏭', 'factory'],['🏯', 'Japanese_castle'],
            ['🏰', 'castle'],['💒', 'wedding'],['🗼', 'Tokyo_tower'],['🗽', 'Statue_of_Liberty'],['⛪', 'church'],
            ['🕌', 'mosque'],['🛕', 'hindu_temple'],['🕍', 'synagogue'],['⛩', 'shinto_shrine'],['🕋', 'kaaba'],
            ['⛲', 'fountain'],['⛺', 'tent'],['🌁', 'foggy'],['🌃', 'night_with_stars'],['🏙', 'cityscape'],
            ['🌄', 'sunrise_over_mountains'],['🌅', 'sunrise'],['🌆', 'cityscape_at_dusk'],['🌇', 'sunset'],['🌉', 'bridge_at_night'],
            ['♨', 'hot_springs'],['🎠', 'carousel_horse'],['🛝', 'playground_slide'],['🎡', 'ferris_wheel'],['🎢', 'roller_coaster'],
            ['💈', 'barber_pole'],['🎪', 'circus_tent'],['🚂', 'locomotive'],['🚃', 'railway_car'],['🚄', 'high-speed_train'],
            ['🚅', 'bullet_train'],['🚆', 'train'],['🚇', 'metro'],['🚈', 'light_rail'],['🚉', 'station'],
            ['🚊', 'tram'],['🚝', 'monorail'],['🚞', 'mountain_railway'],['🚋', 'tram_car'],['🚌', 'bus'],
            ['🚍', 'oncoming_bus'],['🚎', 'trolleybus'],['🚐', 'minibus'],['🚑', 'ambulance'],['🚒', 'fire_engine'],
            ['🚓', 'police_car'],['🚔', 'oncoming_police_car'],['🚕', 'taxi'],['🚖', 'oncoming_taxi'],['🚗', 'automobile'],
            ['🚘', 'oncoming_automobile'],['🚙', 'sport_utility_vehicle'],['🛻', 'pickup_truck'],['🚚', 'delivery_truck'],['🚛', 'articulated_lorry'],
            ['🚜', 'tractor'],['🏎', 'racing_car'],['🏍', 'motorcycle'],['🛵', 'motor_scooter'],['🦽', 'manual_wheelchair'],
            ['🦼', 'motorized_wheelchair'],['🛺', 'auto_rickshaw'],['🚲', 'bicycle'],['🛴', 'kick_scooter'],['🛹', 'skateboard'],
            ['🛼', 'roller_skate'],['🚏', 'bus_stop'],['🛣', 'motorway'],['🛤', 'railway_track'],['🛢', 'oil_drum'],
            ['⛽', 'fuel_pump'],['🛞', 'wheel'],['🚨', 'police_car_light'],['🚥', 'horizontal_traffic_light'],['🚦', 'vertical_traffic_light'],
            ['🛑', 'stop_sign'],['🚧', 'construction'],['⚓', 'anchor'],['🛟', 'ring_buoy'],['⛵', 'sailboat'],
            ['🛶', 'canoe'],['🚤', 'speedboat'],['🛳', 'passenger_ship'],['⛴', 'ferry'],['🛥', 'motor_boat'],
            ['🚢', 'ship'],['✈', 'airplane'],['🛩', 'small_airplane'],['🛫', 'airplane_departure'],['🛬', 'airplane_arrival'],
            ['🪂', 'parachute'],['💺', 'seat'],['🚁', 'helicopter'],['🚟', 'suspension_railway'],['🚠', 'mountain_cableway'],
            ['🚡', 'aerial_tramway'],['🛰', 'satellite'],['🚀', 'rocket'],['🛸', 'flying_saucer'],['🛎', 'bellhop_bell'],
            ['🧳', 'luggage'],['⌛', 'hourglass_done'],['⏳', 'hourglass_not_done'],['⌚', 'watch'],['⏰', 'alarm_clock'],
            ['⏱', 'stopwatch'],['⏲', 'timer_clock'],['🕰', 'mantelpiece_clock'],['🕛', 'twelve_o’clock'],['🕧', 'twelve-thirty'],
            ['🕐', 'one_o’clock'],['🕜', 'one-thirty'],['🕑', 'two_o’clock'],['🕝', 'two-thirty'],['🕒', 'three_o’clock'],
            ['🕞', 'three-thirty'],['🕓', 'four_o’clock'],['🕟', 'four-thirty'],['🕔', 'five_o’clock'],['🕠', 'five-thirty'],
            ['🕕', 'six_o’clock'],['🕡', 'six-thirty'],['🕖', 'seven_o’clock'],['🕢', 'seven-thirty'],['🕗', 'eight_o’clock'],
            ['🕣', 'eight-thirty'],['🕘', 'nine_o’clock'],['🕤', 'nine-thirty'],['🕙', 'ten_o’clock'],['🕥', 'ten-thirty'],
            ['🕚', 'eleven_o’clock'],['🕦', 'eleven-thirty'],['🌑', 'new_moon'],['🌒', 'waxing_crescent_moon'],['🌓', 'first_quarter_moon'],
            ['🌔', 'waxing_gibbous_moon'],['🌕', 'full_moon'],['🌖', 'waning_gibbous_moon'],['🌗', 'last_quarter_moon'],['🌘', 'waning_crescent_moon'],
            ['🌙', 'crescent_moon'],['🌚', 'new_moon_face'],['🌛', 'first_quarter_moon_face'],['🌜', 'last_quarter_moon_face'],['🌡', 'thermometer'],
            ['☀', 'sun'],['🌝', 'full_moon_face'],['🌞', 'sun_with_face'],['🪐', 'ringed_planet'],['⭐', 'star'],
            ['🌟', 'glowing_star'],['🌠', 'shooting_star'],['🌌', 'milky_way'],['☁', 'cloud'],['⛅', 'sun_behind_cloud'],
            ['⛈', 'cloud_with_lightning_and_rain'],['🌤', 'sun_behind_small_cloud'],['🌥', 'sun_behind_large_cloud'],['🌦', 'sun_behind_rain_cloud'],['🌧', 'cloud_with_rain'],
            ['🌨', 'cloud_with_snow'],['🌩', 'cloud_with_lightning'],['🌪', 'tornado'],['🌫', 'fog'],['🌬', 'wind_face'],
            ['🌀', 'cyclone'],['🌈', 'rainbow'],['🌂', 'closed_umbrella'],['☂', 'umbrella'],['☔', 'umbrella_with_rain_drops'],
            ['⛱', 'umbrella_on_ground'],['⚡', 'high_voltage'],['❄', 'snowflake'],['☃', 'snowman'],['⛄', 'snowman_without_snow'],
            ['☄', 'comet'],['🔥', 'fire'],['💧', 'droplet'],['🌊', 'water_wave'],// Activities
            ['🎃', 'jack-o-lantern'],
            ['🎄', 'Christmas_tree'],['🎆', 'fireworks'],['🎇', 'sparkler'],['🧨', 'firecracker'],['✨', 'sparkles'],
            ['🎈', 'balloon'],['🎉', 'party_popper'],['🎊', 'confetti_ball'],['🎋', 'tanabata_tree'],['🎍', 'pine_decoration'],
            ['🎎', 'Japanese_dolls'],['🎏', 'carp_streamer'],['🎐', 'wind_chime'],['🎑', 'moon_viewing_ceremony'],['🧧', 'red_envelope'],
            ['🎀', 'ribbon'],['🎁', 'wrapped_gift'],['🎗', 'reminder_ribbon'],['🎟', 'admission_tickets'],['🎫', 'ticket'],
            ['🎖', 'military_medal'],['🏆', 'trophy'],['🏅', 'sports_medal'],['🥇', '1st_place_medal'],['🥈', '2nd_place_medal'],
            ['🥉', '3rd_place_medal'],['⚽', 'soccer_ball'],['⚾', 'baseball'],['🥎', 'softball'],['🏀', 'basketball'],
            ['🏐', 'volleyball'],['🏈', 'american_football'],['🏉', 'rugby_football'],['🎾', 'tennis'],['🥏', 'flying_disc'],
            ['🎳', 'bowling'],['🏏', 'cricket_game'],['🏑', 'field_hockey'],['🏒', 'ice_hockey'],['🥍', 'lacrosse'],
            ['🏓', 'ping_pong'],['🏸', 'badminton'],['🥊', 'boxing_glove'],['🥋', 'martial_arts_uniform'],['🥅', 'goal_net'],
            ['⛳', 'flag_in_hole'],['⛸', 'ice_skate'],['🎣', 'fishing_pole'],['🤿', 'diving_mask'],['🎽', 'running_shirt'],
            ['🎿', 'skis'],['🛷', 'sled'],['🥌', 'curling_stone'],['🎯', 'bullseye'],['🪀', 'yo-yo'],
            ['🪁', 'kite'],['🔫', 'water_pistol'],['🎱', 'pool_8_ball'],['🔮', 'crystal_ball'],['🪄', 'magic_wand'],
            ['🎮', 'video_game'],['🕹', 'joystick'],['🎰', 'slot_machine'],['🎲', 'game_die'],['🧩', 'puzzle_piece'],
            ['🧸', 'teddy_bear'],['🪅', 'piñata'],['🪩', 'mirror_ball'],['🪆', 'nesting_dolls'],['♠', 'spade_suit'],
            ['♥', 'heart_suit'],['♦', 'diamond_suit'],['♣', 'club_suit'],['♟', 'chess_pawn'],['🃏', 'joker'],
            ['🀄', 'mahjong_red_dragon'],['🎴', 'flower_playing_cards'],['🎭', 'performing_arts'],['🖼', 'framed_picture'],['🎨', 'artist_palette'],
            ['🧵', 'thread'],['🪡', 'sewing_needle'],['🧶', 'yarn'],['🪢', 'knot'],// Objects
            ['👓', 'glasses'],
            ['🕶', 'sunglasses'],['🥽', 'goggles'],['🥼', 'lab_coat'],['🦺', 'safety_vest'],['👔', 'necktie'],
            ['👕', 't-shirt'],['👖', 'jeans'],['🧣', 'scarf'],['🧤', 'gloves'],['🧥', 'coat'],
            ['🧦', 'socks'],['👗', 'dress'],['👘', 'kimono'],['🥻', 'sari'],['🩱', 'one-piece_swimsuit'],
            ['🩲', 'briefs'],['🩳', 'shorts'],['👙', 'bikini'],['👚', 'woman’s_clothes'],['🪭', 'folding_hand_fan'],
            ['👛', 'purse'],['👜', 'handbag'],['👝', 'clutch_bag'],['🛍', 'shopping_bags'],['🎒', 'backpack'],
            ['🩴', 'thong_sandal'],['👞', 'man’s_shoe'],['👟', 'running_shoe'],['🥾', 'hiking_boot'],['🥿', 'flat_shoe'],
            ['👠', 'high-heeled_shoe'],['👡', 'woman’s_sandal'],['🩰', 'ballet_shoes'],['👢', 'woman’s_boot'],['🪮', 'hair_pick'],
            ['👑', 'crown'],['👒', 'woman’s_hat'],['🎩', 'top_hat'],['🎓', 'graduation_cap'],['🧢', 'billed_cap'],
            ['🪖', 'military_helmet'],['⛑', 'rescue_worker’s_helmet'],['📿', 'prayer_beads'],['💄', 'lipstick'],['💍', 'ring'],
            ['💎', 'gem_stone'],['🔇', 'muted_speaker'],['🔈', 'speaker_low_volume'],['🔉', 'speaker_medium_volume'],['🔊', 'speaker_high_volume'],
            ['📢', 'loudspeaker'],['📣', 'megaphone'],['📯', 'postal_horn'],['🔔', 'bell'],['🔕', 'bell_with_slash'],
            ['🎼', 'musical_score'],['🎵', 'musical_note'],['🎶', 'musical_notes'],['🎙', 'studio_microphone'],['🎚', 'level_slider'],
            ['🎛', 'control_knobs'],['🎤', 'microphone'],['🎧', 'headphone'],['📻', 'radio'],['🎷', 'saxophone'],
            ['🪗', 'accordion'],['🎸', 'guitar'],['🎹', 'musical_keyboard'],['🎺', 'trumpet'],['🎻', 'violin'],
            ['🪕', 'banjo'],['🥁', 'drum'],['🪘', 'long_drum'],['🪇', 'maracas'],['🪈', 'flute'],
            ['📱', 'mobile_phone'],['📲', 'mobile_phone_with_arrow'],['☎', 'telephone'],['📞', 'telephone_receiver'],['📟', 'pager'],
            ['📠', 'fax_machine'],['🔋', 'battery'],['🪫', 'low_battery'],['🔌', 'electric_plug'],['💻', 'laptop'],
            ['🖥', 'desktop_computer'],['🖨', 'printer'],['⌨', 'keyboard'],['🖱', 'computer_mouse'],['🖲', 'trackball'],
            ['💽', 'computer_disk'],['💾', 'floppy_disk'],['💿', 'optical_disk'],['📀', 'dvd'],['🧮', 'abacus'],
            ['🎥', 'movie_camera'],['🎞', 'film_frames'],['📽', 'film_projector'],['🎬', 'clapper_board'],['📺', 'television'],
            ['📷', 'camera'],['📸', 'camera_with_flash'],['📹', 'video_camera'],['📼', 'videocassette'],['🔍', 'magnifying_glass_tilted_left'],
            ['🔎', 'magnifying_glass_tilted_right'],['🕯', 'candle'],['💡', 'light_bulb'],['🔦', 'flashlight'],['🏮', 'red_paper_lantern'],
            ['🪔', 'diya_lamp'],['📔', 'notebook_with_decorative_cover'],['📕', 'closed_book'],['📖', 'open_book'],['📗', 'green_book'],
            ['📘', 'blue_book'],['📙', 'orange_book'],['📚', 'books'],['📓', 'notebook'],['📒', 'ledger'],
            ['📃', 'page_with_curl'],['📜', 'scroll'],['📄', 'page_facing_up'],['📰', 'newspaper'],['🗞', 'rolled-up_newspaper'],
            ['📑', 'bookmark_tabs'],['🔖', 'bookmark'],['🏷', 'label'],['💰', 'money_bag'],['🪙', 'coin'],
            ['💴', 'yen_banknote'],['💵', 'dollar_banknote'],['💶', 'euro_banknote'],['💷', 'pound_banknote'],['💸', 'money_with_wings'],
            ['💳', 'credit_card'],['🧾', 'receipt'],['💹', 'chart_increasing_with_yen'],['✉', 'envelope'],['📧', 'e-mail'],
            ['📨', 'incoming_envelope'],['📩', 'envelope_with_arrow'],['📤', 'outbox_tray'],['📥', 'inbox_tray'],['📦', 'package'],
            ['📫', 'closed_mailbox_with_raised_flag'],['📪', 'closed_mailbox_with_lowered_flag'],['📬', 'open_mailbox_with_raised_flag'],['📭', 'open_mailbox_with_lowered_flag'],['📮', 'postbox'],
            ['🗳', 'ballot_box_with_ballot'],['✏', 'pencil'],['✒', 'black_nib'],['🖋', 'fountain_pen'],['🖊', 'pen'],
            ['🖌', 'paintbrush'],['🖍', 'crayon'],['📝', 'memo'],['💼', 'briefcase'],['📁', 'file_folder'],
            ['📂', 'open_file_folder'],['🗂', 'card_index_dividers'],['📅', 'calendar'],['📆', 'tear-off_calendar'],['🗒', 'spiral_notepad'],
            ['🗓', 'spiral_calendar'],['📇', 'card_index'],['📈', 'chart_increasing'],['📉', 'chart_decreasing'],['📊', 'bar_chart'],
            ['📋', 'clipboard'],['📌', 'pushpin'],['📍', 'round_pushpin'],['📎', 'paperclip'],['🖇', 'linked_paperclips'],
            ['📏', 'straight_ruler'],['📐', 'triangular_ruler'],['✂', 'scissors'],['🗃', 'card_file_box'],['🗄', 'file_cabinet'],
            ['🗑', 'wastebasket'],['🔒', 'locked'],['🔓', 'unlocked'],['🔏', 'locked_with_pen'],['🔐', 'locked_with_key'],
            ['🔑', 'key'],['🗝', 'old_key'],['🔨', 'hammer'],['🪓', 'axe'],['⛏', 'pick'],
            ['⚒', 'hammer_and_pick'],['🛠', 'hammer_and_wrench'],['🗡', 'dagger'],['⚔', 'crossed_swords'],['💣', 'bomb'],
            ['🪃', 'boomerang'],['🏹', 'bow_and_arrow'],['🛡', 'shield'],['🪚', 'carpentry_saw'],['🔧', 'wrench'],
            ['🪛', 'screwdriver'],['🔩', 'nut_and_bolt'],['⚙', 'gear'],['🗜', 'clamp'],['⚖', 'balance_scale'],
            ['🦯', 'white_cane'],['🔗', 'link'],['⛓', 'chains'],['🪝', 'hook'],['🧰', 'toolbox'],
            ['🧲', 'magnet'],['🪜', 'ladder'],['⚗', 'alembic'],['🧪', 'test_tube'],['🧫', 'petri_dish'],
            ['🧬', 'dna'],['🔬', 'microscope'],['🔭', 'telescope'],['📡', 'satellite_antenna'],['💉', 'syringe'],
            ['🩸', 'drop_of_blood'],['💊', 'pill'],['🩹', 'adhesive_bandage'],['🩼', 'crutch'],['🩺', 'stethoscope'],
            ['🩻', 'x-ray'],['🚪', 'door'],['🛗', 'elevator'],['🪞', 'mirror'],['🪟', 'window'],
            ['🛏', 'bed'],['🛋', 'couch_and_lamp'],['🪑', 'chair'],['🚽', 'toilet'],['🪠', 'plunger'],
            ['🚿', 'shower'],['🛁', 'bathtub'],['🪤', 'mouse_trap'],['🪒', 'razor'],['🧴', 'lotion_bottle'],
            ['🧷', 'safety_pin'],['🧹', 'broom'],['🧺', 'basket'],['🧻', 'roll_of_paper'],['🪣', 'bucket'],
            ['🧼', 'soap'],['🫧', 'bubbles'],['🪥', 'toothbrush'],['🧽', 'sponge'],['🧯', 'fire_extinguisher'],
            ['🛒', 'shopping_cart'],['🚬', 'cigarette'],['⚰', 'coffin'],['🪦', 'headstone'],['⚱', 'funeral_urn'],
            ['🧿', 'nazar_amulet'],['🪬', 'hamsa'],['🗿', 'moai'],['🪧', 'placard'],['🪪', 'identification_card'],
            ...
            ['®', 'registered'],['™', 'trade_mark'],['🔟', 'keycap:_10'],['🔠', 'input_latin_uppercase'],['🔡', 'input_latin_lowercase'],
